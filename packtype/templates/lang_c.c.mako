...
void pack_${name | tc.snake_case}_${obj._pt_name | tc.snake_case} (
    ...
    pack_${name | tc.snake_case}_${field._pt_container._pt_name | tc.snake_case}(obj.${field._pt_name}, packed_${field._pt_name | tc.snake_case});
<%
        field_lsb  = 0
...
%>\
        %endwhile
    obj.${field._pt_name | tc.snake_case} = unpack_${name | tc.snake_case}_${field._pt_container._pt_name | tc.snake_case}(packed_${field._pt_name | tc.snake_case});
    %endfor
