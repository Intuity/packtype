...
// Date created: 2021-09-01T22:36:35.583528
...
// Struct: calendar_date_t (21 bits)
//
typedef struct {
    uint8_t day;
    uint8_t month;
...
// Struct: calendar_time_t (17 bits)
//
typedef struct {
    uint8_t hour;
    uint8_t minute;
...
// Struct: calendar_date_time_t (38 bits)
//
typedef struct {
...
calendar_date_t unpack_calendar_date (
    uint8_t * packed
) {
    calendar_date_t obj;
...
calendar_time_t unpack_calendar_time (
    uint8_t * packed
) {
    calendar_time_t obj;
    // Unpack any referenced structures
...
void pack_calendar_date_time (
    calendar_date_time_t obj,
    uint8_t * packed
) {
    // Clear the structure
...
calendar_date_time_t unpack_calendar_date_time (
    uint8_t * packed
) {
    calendar_date_time_t obj;
    // Unpack any referenced structures
    ...
    obj.date = unpack_calendar_date(packed_date);
    // - time (17 bits)
    uint8_t packed_time[3];
    ...
    obj.time = unpack_calendar_time(packed_time);
    // Unpack any scalar or enumerated fields
    return obj;
}
